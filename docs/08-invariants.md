...
| **INV-BEACON-8** | Safety | **Terminal retention.** A terminated shard's boundary record (including its settled-transaction root) is retained until every dependent has consumed it: split children seeded, merge parent composed, plus the retention horizon. |
