...
| [06-resource-economics.md](06-resource-economics.md) | The self-regulating validator supply: the market-clearing minimum stake, the pool/lifecycle gates it drives, where transaction fees burn and how the fixed emission divides, and vnodes as hardware amortization |
