...
mod tests {
    ...
    use hyperscale_types::{
        BeaconChainConfig, GenesisPool, GenesisValidator, MAX_VOTE_VECTOR_LEN, NetworkDefinition,
        PRODUCTION_BEACON_COMMITTEE_SIZE, Randomness,
    };

    use super::*;
    use crate::state::test_fixtures::pubkey;
