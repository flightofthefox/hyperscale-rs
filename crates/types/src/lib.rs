...
pub use beacon::{
    ...
    ShardRecovery, ShardWitness, ShardWitnessPayload, ShardWitnessProof, ShardWitnessVerifyError,
    SkipReport, SlotEffects, SpcCert, SpcCertVerifyError, SpcEmptyViewMsg,
